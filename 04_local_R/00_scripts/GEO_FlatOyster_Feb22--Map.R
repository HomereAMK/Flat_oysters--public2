...
Map1 <-
  ggplot() +
  geom_sf(data = Global, fill = "#fff5f0", color = "black") +
  geom_sf(data = Coords_Global_sf, aes(fill = Tag), size = 2, show.legend = "point", shape = 21, colour = "black") +
  coord_sf(xlim = c(-20, 30), ylim = c(36, 73), expand = FALSE) +
  geom_label_repel(data = Coords_Global, size = 1, seed = 10, min.segment.length = 0, force = 25, segment.curvature = 1,
                   nudge_x = 0, nudge_y = 0, max.overlaps = Inf, fontface = "bold", colour = "black",
                   aes(x = lon, y = lat, label = Tag,
                       ), alpha = 0.9, show.legend = FALSE) +
  scale_fill_manual(values = c("black","#A02353", "#A02353", "#A02353",
                               "#AD5B35",
                               "#ad7358",
                               "#CC480C",  "#CC480C",
                               "#969696",
                               ...
                               "#588cad", "#588cad", "#588cad", "#588cad", "#588cad",
                               "#240377", "#240377", "#240377", "#240377"), drop = FALSE) +
  scale_colour_manual(values = c("black","#A02353", "#A02353", "#A02353",
                                 "#AD5B35",
                                 "#ad7358",
                                 "#CC480C",  "#CC480C",
                                 "#969696",
